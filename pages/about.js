    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                <SkillBox title="Laravel" description="My PHP Framework of choice"></SkillBox>
                <SkillBox title="PHP" description="The language I write the login and APIs in"></SkillBox>
                <SkillBox title="Javascript" description="For creating beautiful frontends"></SkillBox>
                <SkillBox title="React" description="When the web app needs to feel like a mobile app"></SkillBox>
                <SkillBox title="Nextjs" description="My choice for frontend SPAs"></SkillBox>
                <SkillBox title="Tailwindcss" description="My favorite CSS framework"></SkillBox>
                <SkillBox title="Livewire" description="When I have to avoid the complexity of React"></SkillBox>
                <SkillBox title="Alpinejs" description="For small websites where an SPA is overkill"></SkillBox>
                <SkillBox title="Devops" description="Setting up Linux and Windows servers"></SkillBox>
            </div>
