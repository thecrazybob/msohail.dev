  ...
  return (
    <>
      ...
      <div className="mt-16 grid md:grid-cols-2">
        <div>
          <h3 className="max-w-max border-b-2 border-black py-4 text-3xl dark:border-white">
        ...
        <div>
          <h2 className="max-w-max border-b-2 border-black py-4 text-3xl dark:border-white">
