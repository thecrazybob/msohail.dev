...
export default function Work() {
    return (
        ...
        <Project removePadding={true} title="01 / WEQAYA.AE" linkLabel="Visit the website" linkUrl="https://tinyurl.com/weqayaae" description="I designed and developed the website using cutting-edge technologies. The content is retrieved from a headless-CMS and the COVID-19 cases are retrieved using APIs." tech={[laravelLogo, alpinejsLogo, tailwindcssLogo, twillLogo, livewireLogo]} timeframe="< 1 month" image={weqayaLogo}></Project>
        ...
        <Project title="03 / TRBEI.COM" linkLabel="Visit the website" linkUrl="https://www.trbei.com" description="The project included the development of the sales pages as well as the development of a customized user dashboard and game checkout process." tech={[laravelLogo, bootstrapLogo, wordpressLogo]} timeframe="< 3 months" image={trbeiLogo}></Project>
        <Project title="04 / CASCADEVIRTUAL" linkLabel="Visit the website" linkUrl="https://www.cascadevirtual.com" description="This project involved the development of a customer dashboard and another dashboard for virtual assistants." tech={[phpLogo, codeigniterLogo, stripeLogo]} timeframe="< 1 month" image={cascadevirtualLogo}></Project>
        <Project title="05 / BILTRADER" linkLabel="See the source code" linkUrl="https://github.com/thecrazybob/biltrader-next" description="A classified web app meant for the members of Bilkent University. The app was made as a single page React application connected to Spring Boot via APIs" tech={[reactLogo, vercelLogo, awsLogo, springbootLogo, nextjsLogo]} timeframe="< 1 month" image={biltraderLogo}></Project>
        <Project title="06 / LARAVEL WHMCS PACKAGE" linkLabel="See the source code" linkUrl="https://github.com/thecrazybob/laravel-whmcs" description="A Laravel package which helps connect to WHMCS API. The package is open-sourced on GitHub." tech={[laravelLogo, whmcsLogo, phpLogo]} timeframe="< 1 month" image={laravelwhmcsLogo}></Project>
        <Project title="07 / TESOL CERTIFICATE GENERATOR" linkLabel="See the source code" linkUrl="https://github.com/thecrazybob/tesol-certificate" description="This application was used to generate certificates for the attendes and presentators of TESOL Arabia 2020" tech={[laravelLogo, phpLogo, wordpressLogo]} timeframe="< 1 week" image={tesolLogo}></Project>
