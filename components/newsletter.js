    ...
    return (
        <section className="font-body mb-16 mt-16">
            ...
            <form onSubmit={subscribe} className="border-2 w-full lg:w-3/5 border-black dark:border-white rounded-lg bg-white flex my-10 justify-between">
                ...
                <button className="bg-black max-w-max rounded-md text-white text-xl px-4 py-2 m-3 flex items-center space-x-2" type="submit"><Image alt="Right arrow" layout="fixed" src={arrowIcon}></Image><span>Submit</span></button>
            </form>
