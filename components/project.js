    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div class="flex flex-col space-y-5">
                ...
                <p class="w-2/3 text-xl">I designed and developed the website using cutting-edge technologies. The content is retrieved from a headless-CMS and the COVID-19 cases are retrieved using APIs.</p>
                ...
                <span class="pt-6 border-b border-black max-w-max font-medium tracking-wide">View of all my work ↗</span>
            </div>
